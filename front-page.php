        ...
        <div class="p-index-mv__info-content">
          <div class="p-index-mv__info-header">
            ...
            <div class="p-index-mv__info-link-group">
              <a href="#" class="p-index-mv__info-link"
                >過去のお知らせはこちら</a
              >
            </div>
          </div>
          <a href="#" class="p-index-mv__info-news">
            <time class="p-index-mv__info-news-time" datetime="2021-01-01"
              >2021/01/01</time
            >
            <p class="p-index-mv__info-news-text">
              年末年始の営業時間のお知らせ
            </p>
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              ...
              />
              <path
                d="M8.39453 1L15.0001 8L8.39453 15"
                stroke-width="1.4"
                stroke-linecap="round"
                stroke-linejoin="round"
              />
        ...
        <div class="c-concept__container">
          <div class="c-concept__content">
            ...
            <div class="c-concept__link">
              <a href="#" class="c-concept__button c-button"
                >当院について
            ...
            <div class="p-index-recommend__item">
              ...
              <p class="p-index-recommend__text">
                朝から夜までお仕事をされている方のために、診療時間を見直しました。<br /><span
                  class="p-index-recommend__text__accent"
      ...
      <div class="p-index-medical__inner">
        <div class="p-index-medical__container">
          ...
          <div class="p-index-medical__services">
            <a class="p-index-medical__service p-index-medical--service1">
            ...
            <a class="p-index-medical__service p-index-medical--service2">
              <div class="p-index-medical__service-link-line">
                <div class="p-index-medical__link-container">
          ...
          <p class="p-index-medical__text">
            ...
            <span
              class="p-index-medical-text__accent p-index-medical-text__accent--medical"
    ...
    <section class="c-blog p-index-blog">
      ...
      <div class="c-blog__container p-index-blog__container">
        <div class="c-blog__cards p-index-blog__cards">
          <a class="c-blog__card p-index-blog__card">
            ...
            <div class="c-blog__content">
              <span class="c-blog__label p-index-blog__label">お知らせ</span>
              <p class="c-blog__text p-index-blog__text">
                記事のタイトルが入ります。記事のタイトルが入ります。記事のタイトルが入ります。
              </p>
              <time
                class="c-blog__datetime entry-date published"
                datetime="2025-04-12"
      ...
      <div class="c-blog__link">
        <a href="" class="c-blog__button c-button"
          >スタッフブログ一覧はこちら
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
            <path
              d="M1 7H13"
