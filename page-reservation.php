            ...
            <form action="" method="post" class="p-reservation__form">
              ...
              <div class="p-reservation__row">
                ...
                <div class="p-reservation__data p-reservation__data--radio">
                  ...
                  >
                  <label
                    ><input type="radio" name="visit-type" value="再診" />
                    再診</label
                  >
                </div>
              </div>
              ...
              <div class="p-reservation__row">
                <p class="p-reservation__head">
                  診療内容 <span class="p-reservation__required">必須</span
                  ><br /><small>※複数選択可</small>
                </p>
                <div class="p-reservation__data p-reservation__data--checkbox">
                  <label
                    ><input type="checkbox" name="menu[]" value="虫歯" />
                    虫歯</label
                  >
                  <label
                    ><input
                  ...
                  >
                  <label
                    ><input type="checkbox" name="menu[]" value="矯正相談" />
                    矯正相談</label
                  >
                  <label
                    ><input type="checkbox" name="menu[]" value="飲み合わせ" />
                    飲み合わせ</label
                  >
                  <label
                    ><input type="checkbox" name="menu[]" value="歯の痛み" />
                    歯の痛み</label
                  >
                  <label
                    ><input type="checkbox" name="menu[]" value="歯茎の腫れ" />
                    歯茎の腫れ</label
                  >
                  <label
                    ><input type="checkbox" name="menu[]" value="入れ歯" />
                    入れ歯</label
                  >
                  <label
                    ><input
                  ...
                  >
                  <label
                    ><input type="checkbox" name="menu[]" value="その他" />
                    その他</label
                  >
                </div>
              </div>
